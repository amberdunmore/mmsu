...
typedef struct model_internal {
  ...
  double initial_Sv;
  double initial_t;
  double initial_T_r_cleared;
  double initial_T_r_failed;
  double initial_T_s;
  double Iv_r0;
  double Iv_s0;
  double m;
  ...
  double rD;
  double res_time;
  double resistance_baseline_ratio;
  double resistance_cleared_ratio;
  double resistance_dur_mult;
  double resistance_failed_ratio;
...
SEXP model_create(SEXP user) {
  ...
  R_Free(internal->delay_index_delayed_lambda_v_r_Sv);
  internal->delay_index_delayed_lambda_v_r_Sv = R_Calloc(5, int);
  R_Free(internal->delay_state_delayed_lambda_v_r_Sv);
  internal->delay_state_delayed_lambda_v_r_Sv = R_Calloc(5, double);
  ...
  internal->delay_index_delayed_lambda_v_r_Sv[4] = 8;
  R_Free(internal->delay_index_delayed_lambda_v_s_Sv);
  ...
  internal->delay_index_delayed_lambda_v_s_Sv[3] = 8;
  internal->a = NA_REAL;
  ...
  internal->resistance_baseline_ratio = NA_REAL;
  internal->resistance_cleared_ratio = NA_REAL;
  internal->resistance_dur_mult = NA_REAL;
  internal->resistance_failed_ratio = NA_REAL;
  internal->resistance_trans_mult = NA_REAL;
  internal->rT_r_cleared = NA_REAL;
  internal->rT_r_failed = NA_REAL;
  internal->rT_s = NA_REAL;
  internal->S0 = NA_REAL;
  internal->Sv0 = NA_REAL;
  internal->T_r_cleared0 = NA_REAL;
  internal->T_r_failed0 = NA_REAL;
  internal->T_s0 = NA_REAL;
  internal->toff = NA_REAL;
  internal->ton = NA_REAL;
  internal->treatment_failure_rate = NA_REAL;
...
SEXP model_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 60));
  ...
  SET_VECTOR_ELT(contents, 5, ScalarReal(internal->cA_s));
  SET_VECTOR_ELT(contents, 6, ScalarReal(internal->cD));
  SET_VECTOR_ELT(contents, 7, ScalarReal(internal->cD_s));
  SET_VECTOR_ELT(contents, 8, ScalarReal(internal->cT));
  SET_VECTOR_ELT(contents, 9, ScalarReal(internal->cT_s));
  SET_VECTOR_ELT(contents, 10, ScalarReal(internal->D_r0));
  SET_VECTOR_ELT(contents, 11, ScalarReal(internal->D_s0));
  SEXP delay_index_delayed_lambda_v_r_Sv = PROTECT(allocVector(INTSXP, 5));
  memcpy(INTEGER(delay_index_delayed_lambda_v_r_Sv), internal->delay_index_delayed_lambda_v_r_Sv, 5 * sizeof(int));
  SET_VECTOR_ELT(contents, 12, delay_index_delayed_lambda_v_r_Sv);
  ...
  SET_VECTOR_ELT(contents, 13, delay_index_delayed_lambda_v_s_Sv);
  SEXP delay_state_delayed_lambda_v_r_Sv = PROTECT(allocVector(REALSXP, 5));
  memcpy(REAL(delay_state_delayed_lambda_v_r_Sv), internal->delay_state_delayed_lambda_v_r_Sv, 5 * sizeof(double));
  SET_VECTOR_ELT(contents, 14, delay_state_delayed_lambda_v_r_Sv);
  ...
  SET_VECTOR_ELT(contents, 15, delay_state_delayed_lambda_v_s_Sv);
  SET_VECTOR_ELT(contents, 16, ScalarReal(internal->Ev_r0));
  SET_VECTOR_ELT(contents, 17, ScalarReal(internal->Ev_s0));
  SET_VECTOR_ELT(contents, 18, ScalarReal(internal->ft));
  SET_VECTOR_ELT(contents, 19, ScalarReal(internal->init_res));
  SET_VECTOR_ELT(contents, 20, ScalarReal(internal->initial_A_r));
  SET_VECTOR_ELT(contents, 21, ScalarReal(internal->initial_A_s));
  SET_VECTOR_ELT(contents, 22, ScalarReal(internal->initial_D_r));
  SET_VECTOR_ELT(contents, 23, ScalarReal(internal->initial_D_s));
  SET_VECTOR_ELT(contents, 24, ScalarReal(internal->initial_Ev_r));
  SET_VECTOR_ELT(contents, 25, ScalarReal(internal->initial_Ev_s));
  SET_VECTOR_ELT(contents, 26, ScalarReal(internal->initial_Iv_r));
  SET_VECTOR_ELT(contents, 27, ScalarReal(internal->initial_Iv_s));
  SET_VECTOR_ELT(contents, 28, ScalarReal(internal->initial_S));
  SET_VECTOR_ELT(contents, 29, ScalarReal(internal->initial_Sv));
  SET_VECTOR_ELT(contents, 30, ScalarReal(internal->initial_t));
  SET_VECTOR_ELT(contents, 31, ScalarReal(internal->initial_T_r_cleared));
  SET_VECTOR_ELT(contents, 32, ScalarReal(internal->initial_T_r_failed));
  SET_VECTOR_ELT(contents, 33, ScalarReal(internal->initial_T_s));
  SET_VECTOR_ELT(contents, 34, ScalarReal(internal->Iv_r0));
  SET_VECTOR_ELT(contents, 35, ScalarReal(internal->Iv_s0));
  SET_VECTOR_ELT(contents, 36, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 37, ScalarReal(internal->mu));
  SET_VECTOR_ELT(contents, 38, ScalarReal(internal->n));
  SET_VECTOR_ELT(contents, 39, ScalarReal(internal->phi));
  SET_VECTOR_ELT(contents, 40, ScalarReal(internal->rA));
  SET_VECTOR_ELT(contents, 41, ScalarReal(internal->rD));
  SET_VECTOR_ELT(contents, 42, ScalarReal(internal->res_time));
  SET_VECTOR_ELT(contents, 43, ScalarReal(internal->resistance_baseline_ratio));
  SET_VECTOR_ELT(contents, 44, ScalarReal(internal->resistance_cleared_ratio));
  SET_VECTOR_ELT(contents, 45, ScalarReal(internal->resistance_dur_mult));
  SET_VECTOR_ELT(contents, 46, ScalarReal(internal->resistance_failed_ratio));
  SET_VECTOR_ELT(contents, 47, ScalarReal(internal->resistance_trans_mult));
  SET_VECTOR_ELT(contents, 48, ScalarReal(internal->rT_r_cleared));
  SET_VECTOR_ELT(contents, 49, ScalarReal(internal->rT_r_failed));
  SET_VECTOR_ELT(contents, 50, ScalarReal(internal->rT_s));
  SET_VECTOR_ELT(contents, 51, ScalarReal(internal->S0));
  SET_VECTOR_ELT(contents, 52, ScalarReal(internal->Sv0));
  SET_VECTOR_ELT(contents, 53, ScalarReal(internal->T_r_cleared0));
  SET_VECTOR_ELT(contents, 54, ScalarReal(internal->T_r_failed0));
  SET_VECTOR_ELT(contents, 55, ScalarReal(internal->T_s0));
  SET_VECTOR_ELT(contents, 56, ScalarReal(internal->toff));
  SET_VECTOR_ELT(contents, 57, ScalarReal(internal->ton));
  SET_VECTOR_ELT(contents, 58, ScalarReal(internal->treatment_failure_rate));
  SET_VECTOR_ELT(contents, 59, ScalarLogical(internal->model_use_dde));
  SEXP nms = PROTECT(allocVector(STRSXP, 60));
  ...
  SET_STRING_ELT(nms, 5, mkChar("cA_s"));
  SET_STRING_ELT(nms, 6, mkChar("cD"));
  SET_STRING_ELT(nms, 7, mkChar("cD_s"));
  SET_STRING_ELT(nms, 8, mkChar("cT"));
  SET_STRING_ELT(nms, 9, mkChar("cT_s"));
  SET_STRING_ELT(nms, 10, mkChar("D_r0"));
  SET_STRING_ELT(nms, 11, mkChar("D_s0"));
  SET_STRING_ELT(nms, 12, mkChar("delay_index_delayed_lambda_v_r_Sv"));
  SET_STRING_ELT(nms, 13, mkChar("delay_index_delayed_lambda_v_s_Sv"));
  SET_STRING_ELT(nms, 14, mkChar("delay_state_delayed_lambda_v_r_Sv"));
  SET_STRING_ELT(nms, 15, mkChar("delay_state_delayed_lambda_v_s_Sv"));
  SET_STRING_ELT(nms, 16, mkChar("Ev_r0"));
  SET_STRING_ELT(nms, 17, mkChar("Ev_s0"));
  SET_STRING_ELT(nms, 18, mkChar("ft"));
  SET_STRING_ELT(nms, 19, mkChar("init_res"));
  SET_STRING_ELT(nms, 20, mkChar("initial_A_r"));
  SET_STRING_ELT(nms, 21, mkChar("initial_A_s"));
  SET_STRING_ELT(nms, 22, mkChar("initial_D_r"));
  SET_STRING_ELT(nms, 23, mkChar("initial_D_s"));
  SET_STRING_ELT(nms, 24, mkChar("initial_Ev_r"));
  SET_STRING_ELT(nms, 25, mkChar("initial_Ev_s"));
  SET_STRING_ELT(nms, 26, mkChar("initial_Iv_r"));
  SET_STRING_ELT(nms, 27, mkChar("initial_Iv_s"));
  SET_STRING_ELT(nms, 28, mkChar("initial_S"));
  SET_STRING_ELT(nms, 29, mkChar("initial_Sv"));
  SET_STRING_ELT(nms, 30, mkChar("initial_t"));
  SET_STRING_ELT(nms, 31, mkChar("initial_T_r_cleared"));
  SET_STRING_ELT(nms, 32, mkChar("initial_T_r_failed"));
  SET_STRING_ELT(nms, 33, mkChar("initial_T_s"));
  SET_STRING_ELT(nms, 34, mkChar("Iv_r0"));
  SET_STRING_ELT(nms, 35, mkChar("Iv_s0"));
  SET_STRING_ELT(nms, 36, mkChar("m"));
  SET_STRING_ELT(nms, 37, mkChar("mu"));
  SET_STRING_ELT(nms, 38, mkChar("n"));
  SET_STRING_ELT(nms, 39, mkChar("phi"));
  SET_STRING_ELT(nms, 40, mkChar("rA"));
  SET_STRING_ELT(nms, 41, mkChar("rD"));
  SET_STRING_ELT(nms, 42, mkChar("res_time"));
  SET_STRING_ELT(nms, 43, mkChar("resistance_baseline_ratio"));
  SET_STRING_ELT(nms, 44, mkChar("resistance_cleared_ratio"));
  SET_STRING_ELT(nms, 45, mkChar("resistance_dur_mult"));
  SET_STRING_ELT(nms, 46, mkChar("resistance_failed_ratio"));
  SET_STRING_ELT(nms, 47, mkChar("resistance_trans_mult"));
  SET_STRING_ELT(nms, 48, mkChar("rT_r_cleared"));
  SET_STRING_ELT(nms, 49, mkChar("rT_r_failed"));
  SET_STRING_ELT(nms, 50, mkChar("rT_s"));
  SET_STRING_ELT(nms, 51, mkChar("S0"));
  SET_STRING_ELT(nms, 52, mkChar("Sv0"));
  SET_STRING_ELT(nms, 53, mkChar("T_r_cleared0"));
  SET_STRING_ELT(nms, 54, mkChar("T_r_failed0"));
  SET_STRING_ELT(nms, 55, mkChar("T_s0"));
  SET_STRING_ELT(nms, 56, mkChar("toff"));
  SET_STRING_ELT(nms, 57, mkChar("ton"));
  SET_STRING_ELT(nms, 58, mkChar("treatment_failure_rate"));
  SET_STRING_ELT(nms, 59, mkChar("model_use_dde"));
...
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->resistance_baseline_ratio = user_get_scalar_double(user, "resistance_baseline_ratio", internal->resistance_baseline_ratio, NA_REAL, NA_REAL);
  internal->resistance_cleared_ratio = user_get_scalar_double(user, "resistance_cleared_ratio", internal->resistance_cleared_ratio, NA_REAL, NA_REAL);
  ...
  internal->resistance_failed_ratio = user_get_scalar_double(user, "resistance_failed_ratio", internal->resistance_failed_ratio, NA_REAL, NA_REAL);
  ...
  internal->rT_r_cleared = user_get_scalar_double(user, "rT_r_cleared", internal->rT_r_cleared, NA_REAL, NA_REAL);
  internal->rT_r_failed = user_get_scalar_double(user, "rT_r_failed", internal->rT_r_failed, NA_REAL, NA_REAL);
  ...
  internal->T_r_cleared0 = user_get_scalar_double(user, "T_r_cleared0", internal->T_r_cleared0, NA_REAL, NA_REAL);
  internal->T_r_failed0 = user_get_scalar_double(user, "T_r_failed0", internal->T_r_failed0, NA_REAL, NA_REAL);
  ...
  internal->treatment_failure_rate = user_get_scalar_double(user, "treatment_failure_rate", internal->treatment_failure_rate, NA_REAL, NA_REAL);
  internal->cA_s = internal->cA;
  internal->cD_s = internal->cD;
  internal->cT_s = internal->cT;
  ...
  internal->initial_T_r_cleared = internal->T_r_cleared0;
  internal->initial_T_r_failed = internal->T_r_failed0;
...
SEXP model_set_initial(SEXP internal_p, SEXP t_ptr, SEXP state_ptr, SEXP model_use_dde_ptr) {
  ...
  if (state_ptr != R_NilValue) {
    ...
    internal->initial_T_r_cleared = state[6];
    internal->initial_T_r_failed = state[7];
    internal->initial_Sv = state[8];
    internal->initial_Ev_s = state[9];
    internal->initial_Iv_s = state[10];
    internal->initial_Ev_r = state[11];
    internal->initial_Iv_r = state[12];
  }
  return R_NilValue;
}
SEXP model_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(variable_names, 6, mkChar("T_r_cleared"));
  SET_STRING_ELT(variable_names, 7, mkChar("T_r_failed"));
  SET_STRING_ELT(variable_names, 8, mkChar("Sv"));
  SET_STRING_ELT(variable_names, 9, mkChar("Ev_s"));
  SET_STRING_ELT(variable_names, 10, mkChar("Iv_s"));
  SET_STRING_ELT(variable_names, 11, mkChar("Ev_r"));
  SET_STRING_ELT(variable_names, 12, mkChar("Iv_r"));
  ...
  SET_STRING_ELT(output_names, 5, mkChar("prevalence_resistant_treated"));
  SET_STRING_ELT(output_names, 6, mkChar("prevalence_resistant_cleared"));
  SET_STRING_ELT(output_names, 7, mkChar("prevalence_resistant_failed"));
  SET_STRING_ELT(output_names, 8, mkChar("EIR_s"));
  SET_STRING_ELT(output_names, 9, mkChar("EIR_r"));
  SET_STRING_ELT(output_names, 10, mkChar("EIR_global"));
  SET_STRING_ELT(output_names, 11, mkChar("invading_A_r_out"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(12));
  UNPROTECT(2);
  return ret;
}
SEXP model_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  ...
  model_internal *internal = model_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 13));
  ...
  state[6] = internal->initial_T_r_cleared;
  state[7] = internal->initial_T_r_failed;
  state[8] = internal->initial_Sv;
  state[9] = internal->initial_Ev_s;
  state[10] = internal->initial_Iv_s;
  state[11] = internal->initial_Ev_r;
  state[12] = internal->initial_Iv_r;
  UNPROTECT(1);
  return r_state;
}
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double D_r = state[4];
  double A_r = state[5];
  double T_r_cleared = state[6];
  double T_r_failed = state[7];
  double Sv = state[8];
  double Ev_s = state[9];
  double Iv_s = state[10];
  double Ev_r = state[11];
  double Iv_r = state[12];
  double cA_r = internal->cA * (t > internal->ton && t < internal->toff ? internal->resistance_baseline_ratio : 1);
  double cD_r = internal->cD * (t > internal->ton && t < internal->toff ? internal->resistance_baseline_ratio : 1);
  double cT_r_cleared = internal->cT * (t > internal->ton && t < internal->toff ? internal->resistance_cleared_ratio : 1);
  double cT_r_failed = internal->cT * (t > internal->ton && t < internal->toff ? internal->resistance_failed_ratio : 1);
  ...
  double delayed_lambda_v_r_Sv;
  {
    ...
    if (t <= internal->initial_t) {
      ...
      T_r_cleared = internal->initial_T_r_cleared;
      T_r_failed = internal->initial_T_r_failed;
      Sv = internal->initial_Sv;
    } else {
      lagvalue(t, internal->model_use_dde, internal->delay_index_delayed_lambda_v_r_Sv, 5, internal->delay_state_delayed_lambda_v_r_Sv);
      D_r = internal->delay_state_delayed_lambda_v_r_Sv[0];
      A_r = internal->delay_state_delayed_lambda_v_r_Sv[1];
      T_r_cleared = internal->delay_state_delayed_lambda_v_r_Sv[2];
      T_r_failed = internal->delay_state_delayed_lambda_v_r_Sv[3];
      Sv = internal->delay_state_delayed_lambda_v_r_Sv[4];
    }
    double cA_r = internal->cA * (t > internal->ton && t < internal->toff ? internal->resistance_baseline_ratio : 1);
    double cD_r = internal->cD * (t > internal->ton && t < internal->toff ? internal->resistance_baseline_ratio : 1);
    double cT_r_cleared = internal->cT * (t > internal->ton && t < internal->toff ? internal->resistance_cleared_ratio : 1);
    double cT_r_failed = internal->cT * (t > internal->ton && t < internal->toff ? internal->resistance_failed_ratio : 1);
    double lambda_v_r = internal->a * (cA_r * A_r + cD_r * D_r + cT_r_cleared * T_r_cleared + cT_r_failed * T_r_failed);
  ...
  double delayed_lambda_v_s_Sv;
  {
    ...
    double lambda_v_s = internal->a * (internal->cA_s * A_s + internal->cD_s * D_s + internal->cT_s * T_s);
  ...
  double invading_T_r_cleared = (t < internal->res_time || t > (internal->res_time + 1) ? 0 : T_s * log(1 / (double) (1 - internal->init_res)) * (1 - internal->treatment_failure_rate));
  double invading_T_r_failed = (t < internal->res_time || t > (internal->res_time + 1) ? 0 : T_s * log(1 / (double) (1 - internal->init_res)) * internal->treatment_failure_rate);
  double lambda_r = internal->m * internal->a * internal->b * Iv_r * internal->resistance_trans_mult;
  double lambda_s = internal->m * internal->a * internal->b * Iv_s;
  dstatedt[5] = invading_A_r + (S * lambda_r * (1 - internal->phi) + lambda_r * A_s * (1 - internal->phi) + D_r * internal->rD + T_r_failed * internal->rT_r_failed - lambda_r * A_r * internal->phi * (1 - internal->ft) - lambda_r * A_r * internal->phi * internal->ft - lambda_s * A_r * internal->phi * (1 - internal->ft) - lambda_s * A_r * internal->phi * internal->ft - lambda_s * A_r * (1 - internal->phi) - A_r * internal->rA);
  ...
  dstatedt[12] = invading_Iv_r + (delayed_lambda_v_r_Sv - internal->mu * Iv_r);
  dstatedt[10] = delayed_lambda_v_s_Sv - internal->mu * Iv_s - invading_Iv_r;
  dstatedt[0] = (-(S) * lambda_s * (internal->phi * internal->ft + internal->phi * (1 - internal->ft) + (1 - internal->phi)) - S * lambda_r * (internal->phi * internal->ft + internal->phi * (1 - internal->ft) + (1 - internal->phi)) + T_s * internal->rT_s + A_s * internal->rA + A_r * internal->rA + T_r_cleared * internal->rT_r_cleared);
  dstatedt[6] = invading_T_r_cleared + (S * lambda_r * internal->phi * internal->ft * (1 - internal->treatment_failure_rate) + lambda_r * A_r * internal->phi * internal->ft * (1 - internal->treatment_failure_rate) + lambda_r * A_s * internal->phi * internal->ft * (1 - internal->treatment_failure_rate) - T_r_cleared * internal->rT_r_cleared);
  dstatedt[7] = invading_T_r_failed + (S * lambda_r * internal->phi * internal->ft * internal->treatment_failure_rate + lambda_r * A_r * internal->phi * internal->ft * internal->treatment_failure_rate + lambda_r * A_s * internal->phi * internal->ft * internal->treatment_failure_rate - T_r_failed * internal->rT_r_failed);
  dstatedt[3] = (S * lambda_s * internal->phi * internal->ft + lambda_s * A_r * internal->phi * internal->ft + lambda_s * A_s * internal->phi * internal->ft - T_s * internal->rT_s) - invading_T_r_cleared - invading_T_r_failed;
  double lambda_v_r = internal->a * (cA_r * A_r + cD_r * D_r + cT_r_cleared * T_r_cleared + cT_r_failed * T_r_failed);
  double lambda_v_s = internal->a * (internal->cA_s * A_s + internal->cD_s * D_s + internal->cT_s * T_s);
  dstatedt[11] = invading_Ev_r + (lambda_v_r * Sv - delayed_lambda_v_r_Sv - internal->mu * Ev_r);
  dstatedt[9] = lambda_v_s * Sv - delayed_lambda_v_s_Sv - internal->mu * Ev_s - invading_Ev_r;
  dstatedt[8] = internal->mu - (lambda_v_s + lambda_v_r) * Sv - internal->mu * Sv;
  if (output) {
    double EIR_r = internal->m * internal->a * Iv_r * 365;
    double EIR_s = internal->m * internal->a * Iv_s * 365;
    output[2] = S + D_s + A_s + T_s + D_r + A_r + T_r_cleared + T_r_failed;
    output[3] = Sv + Ev_s + Iv_s + Ev_r + Iv_r;
    output[0] = A_s + D_s + T_s + A_r + D_r + T_r_cleared + T_r_failed;
    output[1] = (A_r + D_r + T_r_cleared + T_r_failed) / (double) (A_s + D_s + T_s + A_r + D_r + T_r_cleared + T_r_failed);
    output[6] = T_r_cleared;
    output[7] = T_r_failed;
    output[5] = T_r_cleared + T_r_failed;
    output[4] = A_s + D_s + T_s;
    double EIR_global = EIR_s + EIR_r;
    output[9] = EIR_r;
    output[8] = EIR_s;
    output[11] = invading_A_r;
    output[10] = EIR_global;
  }
}
void model_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
...
SEXP model_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  model_internal *internal = model_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 12));
