...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  dstatedt[5] = invading_A_r + (S * lambda_r * (1 - internal->phi) + lambda_r * A_s * (1 - internal->phi) + D_r * rD_r + T_r_failed * internal->rT_r_failed - lambda_r * A_r * internal->phi * (1 - internal->ft) - lambda_r * A_r * internal->phi * internal->ft - lambda_s * A_r * internal->phi * (1 - internal->ft) - lambda_s * A_r * internal->phi * internal->ft - lambda_s * A_r * (1 - internal->phi) - A_r * rA_r);
