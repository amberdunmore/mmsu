model_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("a", "A_r0", "A_s0", "b", "cA", "cD", "cT", "D_r0", "D_s0",
             ...
             "n", "phi", "rA", "rD", "res_time", "resistance_baseline_ratio",
             "resistance_cleared_ratio", "resistance_dur_mult",
             "resistance_failed_ratio", "resistance_trans_mult",
             "rT_r_cleared", "rT_r_failed", "rT_s", "S0", "Sv0",
             "T_r_cleared0", "T_r_failed0", "T_s0", "toff", "ton",
    ...
    registration = function() {
      if (FALSE) {
        .C("model_rhs_dde", package = "modela64ce7ce")
        .C("model_rhs_desolve", package = "modela64ce7ce")
        .C("model_initmod_desolve", package = "modela64ce7ce")
        .C("model_output_dde", package = "modela64ce7ce")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("model_create", user, PACKAGE = "modela64ce7ce")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("model_set_user", private$ptr, user, PACKAGE = "modela64ce7ce")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("model_initial_conditions", private$ptr, t, PACKAGE = "modela64ce7ce")
    },

    rhs = function(t, y) {
      .Call("model_rhs_r", private$ptr, t, y, PACKAGE = "modela64ce7ce")
    },
    ...
    contents = function() {
      .Call("model_contents", private$ptr, PACKAGE = "modela64ce7ce")
    },
